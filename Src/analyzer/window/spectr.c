...
void FX_ShowResult(void)
{
    ...
    if (fx > fmaxSIhz)
        PowerMax *= 1.5;
    if ((found == 1) && (PowerMax > 164.0))
    {   // trigger value: ~ 2.2mV <=>      -40 dBm: 164
        ...
        if (powermw > 1.0f)
            ...
            sprintf(string1, "P: %.3f uW = %.0f dBm    ", powermw * 1000, powerdb);
...
static const TEXTBOX_t tb_Scan[] = {
    (TEXTBOX_t){.x0 = 2, .y0 = 60, .text = "Full Scale", .font = FONT_FRANBIG, .width = 120, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))Full, .cbparam = 1, .next = (void *)&tb_Scan[1]},
    (TEXTBOX_t){.x0 = 2, .y0 = 110, .text = "Ham Bands", .font = FONT_FRANBIG, .width = 120, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))HamBands, .cbparam = 1, .next = (void *)&tb_Scan[2]},
    (TEXTBOX_t){.x0 = 2, .y0 = 234, .text = "Exit", .font = FONT_FRANBIG, .width = 70, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_RED, .cb = (void (*)(void))SCExit, .cbparam = 1, .next = (void *)&tb_Scan[3]},
    (TEXTBOX_t){.x0 = 80, .y0 = 234, .text = "Auto", .font = FONT_FRANBIG, .width = 70, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))Auto, .cbparam = 1, .next = (void *)&tb_Scan[4]},
    (TEXTBOX_t){.x0 = 160, .y0 = 234, .text = "Frequency", .font = FONT_FRANBIG, .width = 120, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))freq, .cbparam = 1, .next = (void *)&tb_Scan[5]},
    (TEXTBOX_t){.x0 = 2, .y0 = 160, .text = "One Band", .font = FONT_FRANBIG, .width = 120, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))OneBand, .cbparam = 1, .next = (void *)&tb_Scan[6]},
    (TEXTBOX_t){.x0 = 290, .y0 = 234, .text = "Test", .font = FONT_FRANBIG, .width = 58, .height = FieldH, .center = 1, .border = 1, .fgcolor = LCD_WHITE, .bgcolor = LCD_BLACK, .cb = (void (*)(void))Test, .cbparam = 1, .next = (void *)&tb_Scan[7]},
    (TEXTBOX_t){
        .x0 = 352,
        .y0 = 234,
        .text = "Spectrum",
