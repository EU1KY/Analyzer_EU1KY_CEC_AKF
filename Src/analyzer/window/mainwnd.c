...
static const TEXTBOX_t volt_menu[] = {
    (TEXTBOX_t){.x0 = COL1, .y0 = 10, .text = " -0.01 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = minus10, .cbparam = 1, .next = (void *)&volt_menu[1]},
    (TEXTBOX_t){.x0 = COL3, .y0 = 10, .text = " +0.01 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = plus10, .cbparam = 1, .next = (void *)&volt_menu[2]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 60, .text = " -0.1 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = minus100, .cbparam = 1, .next = (void *)&volt_menu[3]},
    (TEXTBOX_t){.x0 = COL3, .y0 = 60, .text = " +0.1 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = plus100, .cbparam = 1, .next = (void *)&volt_menu[4]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 110, .text = " -1.0 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = minus1000, .cbparam = 1, .next = (void *)&volt_menu[5]},
    (TEXTBOX_t){.x0 = COL3, .y0 = 110, .text = " +1.0 ", .font = FONT_FRANBIG, .width = 90, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = plus1000, .cbparam = 1, .next = (void *)&volt_menu[6]},
    (TEXTBOX_t){.x0 = 110, .y0 = 110, .text = "Set Max Value", .font = FONT_FRANBIG, .width = 220, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = SetMax, .cbparam = 1, .next = (void *)&volt_menu[7]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 160, .text = " Volt Max Displ  ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = VoltCase1, .cbparam = 1, .next = (void *)&volt_menu[8]},
    (TEXTBOX_t){.x0 = COL2, .y0 = 160, .text = " Volt Min Displ ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = VoltCase2, .cbparam = 1, .next = (void *)&volt_menu[9]},
    (TEXTBOX_t){.x0 = COL2, .y0 = 210, .text = "Voltage Display Off", .font = FONT_FRANBIG, .width = 240, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = VoltOff, .cbparam = 1, .next = (void *)&volt_menu[10]},
    (TEXTBOX_t){
        .x0 = COL1,
        .y0 = 210,
        .text = " Main Menu ",
...
{ // Date/Time real time clock
    ...
    for (k = 0; k < 2; k++)
    {
        ...
        sprintf(txt, "Time: %04d : %02d ", (int)time, (int)second);
        FONT_Write(FONT_FRANBIG, TextColor, BackGrColor, 240, 80, txt);
        sprintf(txt, "Date: %08d ", (int)date);
...
static const TEXTBOX_t tb_menu1[] = {
    (TEXTBOX_t){.x0 = COL1, .y0 = 10, .text = " Colours/Beep ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = Colours, .cbparam = 1, .next = (void *)&tb_menu1[1]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 60, .text = " Configuration ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = CFG_ParamWnd, .cbparam = 1, .next = (void *)&tb_menu1[2]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 110, .text = " Calibration  ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = MenuCalibration, .cbparam = 1, .next = (void *)&tb_menu1[3]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 160, .text = " DSP ", .font = FONT_FRANBIG, .width = 200, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = FFTWND_Proc, .cbparam = 1, .next = (void *)&tb_menu1[4]},
    (TEXTBOX_t){.x0 = COL2, .y0 = 10, .text = " Accu Settings ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = MenuAccu, .cbparam = 1, .next = (void *)&tb_menu1[5]},
    (TEXTBOX_t){.x0 = COL2, .y0 = 60, .text = " Date/Time ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = MenuRTC, .cbparam = 1, .next = (void *)&tb_menu1[6]},

    (TEXTBOX_t){.x0 = COL2, .y0 = 110, .text = "Manage SnapShot", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = Reload_Proc, .cbparam = 1, .next = (void *)&tb_menu1[7]},

    (TEXTBOX_t){.x0 = COL2, .y0 = 160, .text = "USB HS Transfer", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = USBD_Proc, .cbparam = 1, .next = (void *)&tb_menu1[8]},

    (TEXTBOX_t){.x0 = COL2, .y0 = 210, .text = " Flip Screen ", .font = FONT_FRANBIG, .width = 210, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = Rotate, .cbparam = 1, .next = (void *)&tb_menu1[9]},
...
uint32_t TestLoopOsci(uint32_t f_begin, uint32_t f_stop)
{
    ...
    for (fhz1 = f_begin; fhz1 <= f_stop; fhz1 += step)
    {
        ...
        sprintf(str1, "Fosc : %d MHz", (int)(fhz1 / 1000000));
...
TEXTBOX_t hbEx1 = (TEXTBOX_t){.x0 = 10, .y0 = 200, .text = " Cancel and exit ", .font = FONT_FRANBIG, .fgcolor = LCD_BLUE, .bgcolor = LCD_YELLOW, .cb = hit_ex1};
TEXTBOX_t hbSave1 = (TEXTBOX_t){.x0 = 300, .y0 = 200, .text = " Save and exit ", .font = FONT_FRANBIG, .fgcolor = LCD_RGB(128, 128, 128), .bgcolor = LCD_RGB(64, 64, 64), .cb = hit_save1};
...
{ // ************************************************************************************************
    ...
    if (fmax1 < fmax2)
        ...
        f5 = fmax2; //calculate the minimum
    if (fmax3 < f5)
        f5 = fmax3;
    ...
    //else f5=5*fmax;
    for (k = 1; k < 6; k++)
    { // search for highest value in list, take the lower neighbor
    ...
    f5 = 5 * fmax;
    sprintf(str1, "FMAX(S15351) %d MHz, MAX_FREQ %d MHz", (int)(fmax / 1000000), (int)(f5 / 1000000));
...
static const TEXTBOX_t tb_menu2[] = {
    (TEXTBOX_t){.x0 = COL1, .y0 = 20, .text = " OSL Calibration, use calibration kit !!! ", .font = FONT_FRANBIG, .width = 440, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = OSL_CalWnd, .cbparam = 1, .next = (void *)&tb_menu2[1]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 70, .text = " HW Calibration, only at first run !!!  ", .font = FONT_FRANBIG, .width = 440, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = OSL_CalErrCorr, .cbparam = 1, .next = (void *)&tb_menu2[2]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 120, .text = "|S21] Gain Calibration for VNA ", .font = FONT_FRANBIG, .width = 440, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = OSL_CalTXCorr, .cbparam = 1, .next = (void *)&tb_menu2[3]},
    (TEXTBOX_t){.x0 = COL1, .y0 = 170, .text = " Oscillator Test (Fmax) ", .font = FONT_FRANBIG, .width = 440, .height = 34, .center = 1, .border = 1, .fgcolor = M_FGCOLOR, .bgcolor = M_BGCOLOR, .cb = OsciTest, .cbparam = 1, .next = (void *)&tb_menu2[4]},
    (TEXTBOX_t){
        .x0 = COL1,
        .y0 = 210,
        .text = " Main Menu ",
