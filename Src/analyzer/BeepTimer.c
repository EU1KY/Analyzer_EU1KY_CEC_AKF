...
static void UB_TIMER4_Init_FRQ(uint32_t frq_hz) __attribute__((unused));
static void UB_TIMER4_Start(void) __attribute__((unused));
static void UB_TIMER4_Stop(void) __attribute__((unused));
...
// Timer starten
//--------------------------------------------------------------
static void UB_TIMER4_Start(void)
{
  // Timer enable
