...
function write_timestamp {
    ...
    echo \#define BUILD_TIMESTAMP_US \"${CurrYear}-${CurrMonth}-${CurrDay} ${CurrHour}:${CurrMinute} UT\" >> Src/Inc/build_timestamp.h
    echo \#define BUILD_TIMESTAMP_D \"${CurrDay}-${CurrMonth}-${CurrYear} ${CurrHour}:${CurrMinute} UT\" >> Src/Inc/build_timestamp.h
